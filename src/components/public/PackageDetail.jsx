          ...
          <div>
            ...
            <div className="mt-6 space-y-4">
              <p className="flex items-center text-gray-800 text-lg">
                <FaMapMarkerAlt className="mr-3 text-teal-700" /> <span className="font-semibold">{packageData.location}</span>
              </p>
              <p className="flex items-center text-gray-800 text-lg">
                <FaClock className="mr-3 text-green-700" /> <span className="font-semibold">{packageData.duration}</span>
              </p>
              <p className="flex items-center text-gray-800 text-lg">
            ...
            <div className="mt-10 flex justify-between items-center">
              ...
              <button
                ...
                className="bg-teal-700 text-white px-8 py-4 rounded-lg text-lg font-bold shadow-lg hover:bg-teal-800 transition duration-300"
              >
                Book Now
              </button>
            </div>
