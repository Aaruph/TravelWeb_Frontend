...
const Checkout = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("http://localhost:3000/api/v1/bookings", {
        packageId: id,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  ...
                  <ul className="space-y-2 mt-2">
                    {Array.isArray(packageData.itinerary) && packageData.itinerary.length > 0 ? (
                      packageData.itinerary.map((day, index) => {
                        let dayData = typeof day === "string" ? JSON.parse(day) : day; // Ensure correct format
          ...
          <div className="bg-white shadow-lg rounded-lg p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Payment Options */}
              <div>
                <h4 className="text-lg font-semibold text-gray-700 mb-2">💳 Payment Method</h4>
                <select
                  name="paymentMethod"
