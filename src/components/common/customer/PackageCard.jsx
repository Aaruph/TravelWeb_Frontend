    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition duration-300">
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-center mt-4">
          <span className="text-teal-800 font-bold text-lg">₹{packageData.price}</span>
          <Link to={`/packages/${packageData._id}`} className="bg-teal-800 text-white px-4 py-2 rounded-md text-sm hover:bg-teal-700">
            View Details
          </Link>
        </div>
      </div>
